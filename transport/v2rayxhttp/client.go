...
func NewClient(ctx context.Context, dialer N.Dialer, serverAddr M.Socksaddr, options option.V2RayXHTTPOptions, tlsConfig tls.Config) (adapter.V2RayClientTransport, error) {
	...
	if options.Download != nil {
		...
		secondaryXmux = NewXmuxManager(xmuxOptions2, func() XmuxConn {
			return createHTTPClient(dest2, dialer2, &options2.V2RayXHTTPBaseOptions, tlsConfig2)
		})
		getHTTPClient2 = func() (DialerClient, *XmuxClient) {
			xmuxClient2 := secondaryXmux.GetXmuxClient(ctx)
	...
	return &Client{
		...
		primaryXmux:     primaryXmux,
		secondaryXmux:   secondaryXmux,
	}, nil
}

func resolveLogger(ctx context.Context) log.ContextLogger {
...
func (c *Client) Close() error {
	if c.secondaryXmux != nil && c.secondaryXmux != c.primaryXmux {
		return errors.Join(c.primaryXmux.Close(), c.secondaryXmux.Close())
	}
	if c.primaryXmux != nil {
		return c.primaryXmux.Close()
	}
	return nil
}
